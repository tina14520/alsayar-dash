<template>
  <section class="countries">
    <sweet-modal ref="editModal" title="Edit Country">
    ...
    <sweet-modal ref="warningModal" icon="error" title="Delete Country">
      Are you sure ?
      <p></p>
      <!--<div class="buttons">
     <div class="back">
    ...
    <h1>Countries</h1>
    <div class="add">
      <button @click="add" class="add-btn">Add Country</button>
    </div>
    <div style="width: 600px">
      ...
      <sweet-modal ref="addCountryModal" title="Add Country">
