<template>
  <section class="countries">
    <sweet-modal ref="editModal" title="Edit Voucher">
    ...
    <sweet-modal ref="warningModal" icon="error" title="Delete Voucher">
      Are you sure ?
      <p></p>
      <!--<div class="buttons">
     <div class="back">
    ...
    <div style="width: 600px">
      ...
      <sweet-modal ref="addCountryModal" title="Add Voucher">
