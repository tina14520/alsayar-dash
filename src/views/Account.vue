<template>
  <section class="account">
    <sweet-modal ref="editModal" title="Edit Account">
      <FormulateForm v-model="rowElments" @submit="editAccount">
        <FormulateInput
          type="text"
          name="name"
    ...
    <sweet-modal ref="warningModal" icon="error" title="Delete account">
      Are you sure ?
      <p></p>
      <!--<div class="buttons">
     <div class="back">
    ...
    <div style="width: 600px">
      ...
      <sweet-modal ref="addAccountModal" title="Add Account">
        <FormulateForm v-model="formValues" @submit="addAccount">
          <FormulateInput
            type="text"
            name="name"
            placeholder="Account Name"
