<template>
  <section class="payments">
    <sweet-modal ref="editModal" title="Edit Payment">
    ...
    <sweet-modal ref="warningModal" icon="error" title="Delete payment">
      Are you sure ?
      <p></p>
      <!--<div class="buttons">
     <div class="back">
    ...
    <div style="width: 600px">
      ...
      <sweet-modal ref="addCountryModal" title="Add Payment">
